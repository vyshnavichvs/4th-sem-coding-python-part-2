def count_subarray_sum_less_than_k(arr, k):
    ...
    for subarray_end in range(len(arr)):
        ...
        count += subarray_end - subarray_start + 1
...
count = count_subarray_sum_less_than_k(array, k)

print("Count of subarrays with sum less than", k, ":", count)
